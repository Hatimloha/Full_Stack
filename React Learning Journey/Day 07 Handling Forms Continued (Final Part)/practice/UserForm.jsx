...
const UserForm = () => {
  ...
  return (
    <div className='outerContainer'>
        <div className='innerContainer border-2 rounded-2xl w-150 m-auto h-100 bg-cyan-200 text-black p-5'>
            ...
            <div className='details flex flex-col justify-center items-center'>
                ...
                <select className='mt-5 w-100' value={city} onChange={(e) => setCity(e.target.value)}>
