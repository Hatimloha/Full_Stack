...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // remove password and refresh token frm the field
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // find the email and username in DB
    ...
    // After using this cookie can be modify throuh server only
    const options = {
        httpOnly: true,
        secure: true,
    }
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, user, 'New account details updated successfully')
        )
